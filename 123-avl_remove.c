...
/**
 * bal - Measures the balance factor of an AVL tree and performs rotations if needed.
 * @tree: Pointer to the root node of the AVL tree.
 *
 * Description: This function measures the balance factor of each node in the AVL tree
 *              recursively and performs rotations to balance the tree if necessary.
 */
void bal(avl_t **tree)
{
	int bval;
 ...
 *
 * Return: The value of the next successor of the given node.
 */
 ...
 * @root: Pointer to the node to be removed from the binary search tree.
 *
 * Return: 0 if the node has no children, otherwise returns the value of the successor.
 */
